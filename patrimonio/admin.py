    ...
    def importar_csv_view(self, request):
        ...
        if request.method == "POST":
            ...
            if acao == "importar" and temp_path:
                ...
                messages.success(request, f"Importa̤̣o aplicada. Novos: {res['novos']} | Atualizados: {res['atualizados']} | Movidos: {res['movidos']} | Baixados: {res['baixados']} | Reativados: {res['reativados']} | Sem mudan̤a: {res['sem_mudanca']} | Ausentes: {res['ausentes']}")
